    ...
    <section class="cont text-gray-600 body-font relative">
        <div class="container py-24 mx-auto flex flex-col lg:grid grid-cols-2 gap-8">
            <div class=" bg-gray-300 overflow-hidden py-44 md:p-10 md:pt-72 lg:p-5 flex items-end justify-start relative">
                <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed/v1/place?q=12+Oladele+Kadiri+Close,+Agege,+Nigeria&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
                <div class="bg-white relative hidden md:flex flex-wrap py-6 shadow-sm text-sm">
                    <div class="lg:w-1/2 px-6">
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest">ADDRESS</h2>
                        <p class="mt-1">Plot 12, Oladele Kadiri close Off Nob-Oluwa Street, Ogba, Ikeja Lagos.</p>
                    </div>
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                        <a href="mailto:hi@zenithprecision.com.ng" class="text-whine leading-relaxed">hi@zenithprecision.com.ng</a>
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                        <a href="tel:+2348081989240" class="leading-relaxed text-whine">+2348 081 989 240</a>
                    </div>
                </div>
            </div>
